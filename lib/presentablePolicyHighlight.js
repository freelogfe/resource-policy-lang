...
var resourcePolicyLexer = require (`${gen_dir}/resourcePolicyLexer`)
var resourcePolicyParser = require (`${gen_dir}/resourcePolicyParser`)
var camelcase = require('camelcase')

export default function highlightPolicy (segmentText){
