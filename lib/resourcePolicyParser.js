...
var symbolicNames = [ null, null, null, null, null, null, null, null, null, 
                      ...
                      "TERMINATE", "INTEGER_NUMBER", "HOUR", "DATE", "TWO_DIGITS", 
                      "FOUR_DIGITS", "NIGHT_DIGITS", "ID", "FEATHERACCOUNT", 
                      "WS" ];
...
resourcePolicyParser.INTEGER_NUMBER = 41;
resourcePolicyParser.HOUR = 42;
resourcePolicyParser.DATE = 43;
resourcePolicyParser.TWO_DIGITS = 44;
resourcePolicyParser.FOUR_DIGITS = 45;
resourcePolicyParser.NIGHT_DIGITS = 46;
resourcePolicyParser.ID = 47;
resourcePolicyParser.FEATHERACCOUNT = 48;
resourcePolicyParser.WS = 49;
...
resourcePolicyParser.prototype.segment = function() {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while(((((_la - 35)) & ~0x1f) == 0 && ((1 << (_la - 35)) & ((1 << (resourcePolicyParser.SELF - 35)) | (1 << (resourcePolicyParser.GROUPUSER - 35)) | (1 << (resourcePolicyParser.GROUPNODE - 35)) | (1 << (resourcePolicyParser.NODES - 35)) | (1 << (resourcePolicyParser.PUBLIC - 35)) | (1 << (resourcePolicyParser.INTEGER_NUMBER - 35)) | (1 << (resourcePolicyParser.ID - 35)))) !== 0));
        this.state = 68;
...
resourcePolicyParser.prototype.initial_state_clause = function() {
    ...
    try {
        ...
        this.state = 104;
        _la = this._input.LA(1);
        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << resourcePolicyParser.T__3) | (1 << resourcePolicyParser.T__4) | (1 << resourcePolicyParser.T__5) | (1 << resourcePolicyParser.T__6))) !== 0))) {
...
Transaction_eventContext.prototype.ID = function() {
    return this.getToken(resourcePolicyParser.ID, 0);
};
...
resourcePolicyParser.prototype.users = function() {
    ...
    try {
        ...
        this.state = 222;
        _la = this._input.LA(1);
        if(!(((((_la - 35)) & ~0x1f) == 0 && ((1 << (_la - 35)) & ((1 << (resourcePolicyParser.SELF - 35)) | (1 << (resourcePolicyParser.GROUPUSER - 35)) | (1 << (resourcePolicyParser.GROUPNODE - 35)) | (1 << (resourcePolicyParser.NODES - 35)) | (1 << (resourcePolicyParser.PUBLIC - 35)) | (1 << (resourcePolicyParser.INTEGER_NUMBER - 35)) | (1 << (resourcePolicyParser.ID - 35)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
