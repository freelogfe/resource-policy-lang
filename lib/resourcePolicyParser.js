...
var symbolicNames = [ null, null, null, null, null, null, null, null, null, 
                      ...
                      "TERMINATE", "MOBILEPHONE", "FEATHERACCOUNT", "DOMAIN", 
...
resourcePolicyParser.DOMAIN = 43;
resourcePolicyParser.ID = 44;
resourcePolicyParser.HOUR = 45;
resourcePolicyParser.DATE = 46;
resourcePolicyParser.INTEGER_NUMBER = 47;
resourcePolicyParser.TWO_DIGITS = 48;
resourcePolicyParser.FOUR_DIGITS = 49;
resourcePolicyParser.NIGHT_DIGITS = 50;
resourcePolicyParser.ALPHANUMERIC = 51;
resourcePolicyParser.WS = 52;
...
resourcePolicyParser.prototype.segment = function() {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while(((((_la - 35)) & ~0x1f) == 0 && ((1 << (_la - 35)) & ((1 << (resourcePolicyParser.SELF - 35)) | (1 << (resourcePolicyParser.GROUPUSER - 35)) | (1 << (resourcePolicyParser.GROUPNODE - 35)) | (1 << (resourcePolicyParser.NODES - 35)) | (1 << (resourcePolicyParser.PUBLIC - 35)) | (1 << (resourcePolicyParser.DOMAIN - 35)))) !== 0));
        this.state = 68;
...
UsersContext.prototype.DOMAIN = function() {
    return this.getToken(resourcePolicyParser.DOMAIN, 0);
};
...
resourcePolicyParser.prototype.users = function() {
    ...
    try {
        ...
        this.state = 222;
        _la = this._input.LA(1);
        if(!(((((_la - 35)) & ~0x1f) == 0 && ((1 << (_la - 35)) & ((1 << (resourcePolicyParser.SELF - 35)) | (1 << (resourcePolicyParser.GROUPUSER - 35)) | (1 << (resourcePolicyParser.GROUPNODE - 35)) | (1 << (resourcePolicyParser.NODES - 35)) | (1 << (resourcePolicyParser.PUBLIC - 35)) | (1 << (resourcePolicyParser.DOMAIN - 35)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
