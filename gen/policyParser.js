...
policyParser.GROUPUSER = 27;
policyParser.FOR = 28;
policyParser.REGISTERED_USERS = 29;
policyParser.PUBLIC = 30;
policyParser.NODES = 31;
policyParser.TERMINATE = 32;
policyParser.ID = 33;
policyParser.INTEGER_NUMBER = 34;
policyParser.USERACCOUNT = 35;
...
policyParser.prototype.segment = function() {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while(((((_la - 27)) & ~0x1f) == 0 && ((1 << (_la - 27)) & ((1 << (policyParser.GROUPUSER - 27)) | (1 << (policyParser.REGISTERED_USERS - 27)) | (1 << (policyParser.PUBLIC - 27)) | (1 << (policyParser.NODES - 27)) | (1 << (policyParser.INTEGER_NUMBER - 27)) | (1 << (policyParser.USERACCOUNT - 27)))) !== 0));
        this.state = 72;
...
policyParser.prototype.users = function() {
    ...
    try {
        ...
        this.state = 203;
        _la = this._input.LA(1);
        if(!(((((_la - 27)) & ~0x1f) == 0 && ((1 << (_la - 27)) & ((1 << (policyParser.GROUPUSER - 27)) | (1 << (policyParser.REGISTERED_USERS - 27)) | (1 << (policyParser.PUBLIC - 27)) | (1 << (policyParser.NODES - 27)) | (1 << (policyParser.INTEGER_NUMBER - 27)) | (1 << (policyParser.USERACCOUNT - 27)))) !== 0))) {
