...
var literalNames = [ null, "':'", "'and'", "','", "'user group'", "'in'", 
                     "'proceed to'", "'on'", "'accepting'", "'and on'", 
...
var symbolicNames = [ null, null, null, null, null, null, null, null, null, 
                      ...
                      null, null, null, null, null, null, null, null, null, 
                      null, null, "FOR", "REGISTERED_USERS", "PUBLIC", "NODES", 
                      "TERMINATE", "ID", "INTEGER_NUMBER", "INT", "USERACCOUNT", 
...
policyParser.FOR = 29;
policyParser.REGISTERED_USERS = 30;
policyParser.PUBLIC = 31;
policyParser.NODES = 32;
policyParser.TERMINATE = 33;
policyParser.ID = 34;
policyParser.INTEGER_NUMBER = 35;
policyParser.INT = 36;
policyParser.USERACCOUNT = 37;
policyParser.FEATHERACCOUNT = 38;
policyParser.WS = 39;
...
policyParser.prototype.segment = function() {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << policyParser.T__3) | (1 << policyParser.REGISTERED_USERS) | (1 << policyParser.PUBLIC))) !== 0) || ((((_la - 32)) & ~0x1f) == 0 && ((1 << (_la - 32)) & ((1 << (policyParser.NODES - 32)) | (1 << (policyParser.INTEGER_NUMBER - 32)) | (1 << (policyParser.USERACCOUNT - 32)))) !== 0));
        this.state = 78;
        this.match(policyParser.T__0);
        this.state = 82;
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while(_la===policyParser.T__4 || _la===policyParser.TERMINATE) {
            this.state = 79;
            this.state_clause();
            this.state = 84;
            this._errHandler.sync(this);
...
User_individualContext.prototype.REGISTERED_USERS = function() {
    return this.getToken(policyParser.REGISTERED_USERS, 0);
};

User_individualContext.prototype.PUBLIC = function() {
    return this.getToken(policyParser.PUBLIC, 0);
};

User_individualContext.prototype.NODES = function() {
    return this.getToken(policyParser.NODES, 0);
};

User_individualContext.prototype.USERACCOUNT = function() {
    return this.getToken(policyParser.USERACCOUNT, 0);
};

User_individualContext.prototype.INTEGER_NUMBER = function() {
    return this.getToken(policyParser.INTEGER_NUMBER, 0);
};
...
policyParser.prototype.user_individual = function() {
    ...
    try {
        ...
        this.state = 226;
        _la = this._input.LA(1);
        if(!(((((_la - 30)) & ~0x1f) == 0 && ((1 << (_la - 30)) & ((1 << (policyParser.REGISTERED_USERS - 30)) | (1 << (policyParser.PUBLIC - 30)) | (1 << (policyParser.NODES - 30)) | (1 << (policyParser.INTEGER_NUMBER - 30)) | (1 << (policyParser.USERACCOUNT - 30)))) !== 0))) {
...
User_groupsContext.prototype.ID = function() {
    return this.getToken(policyParser.ID, 0);
};
...
policyParser.prototype.time_unit = function() {
    ...
    try {
        ...
        this.state = 230;
        _la = this._input.LA(1);
        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << policyParser.T__17) | (1 << policyParser.T__25) | (1 << policyParser.T__26) | (1 << policyParser.T__27))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
