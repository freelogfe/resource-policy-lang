...
var literalNames = [ null, "'This contract shall commence with effect from'", 
                     ...
                     "':'", "'The account settlement shall be performed on every'", 
                     "'day in token state'", "'and'", "','", "'users in'", 
                     "'every'", "'day'", "'price priceExpression'", "'transaction of'", 
                     "'to owner'", "'contract_guaranty of'", "'refund after'", 
                     "'platform_guaranty of'", "'visit_increment of'", "'visit of'", 
                     "'account_balance greater than'", "'account_balance smaller than'", 
                     "'account_settled'", "'in total'", "'per view'", "'year'", 
                     "'month'", "'For'", "'usergroups'", "'users'", "'proceed'", 
...
var symbolicNames = [ null, null, null, null, null, null, null, null, null, 
                      ...
                      null, null, null, null, null, null, null, null, null, 
                      "FOR", "USERGROUPS", "USERS", "PROCEED", "TO", "IN", 
                      "ON", "ACCEPTING", "SELF", "LICENSE", "PAYING", "PER", 
                      "VIEW", "REQUIRE", "NOTHING", "ID", "WS", "INT", "DATE" ];

var ruleNames =  [ "p", "duration_clause", "segment", "settlement_clause", 
                   "audience_clause", "audience_individuals_clause", "audience_groups_clause", 
                   "state_clause", "current_state_clause", "target_clause", 
                   "accepting", "event", "and_event", "settlement_time_event", 
...
policyParser.FOR = 27;
policyParser.USERGROUPS = 28;
policyParser.USERS = 29;
policyParser.PROCEED = 30;
policyParser.TO = 31;
policyParser.IN = 32;
policyParser.ON = 33;
policyParser.ACCEPTING = 34;
policyParser.SELF = 35;
policyParser.LICENSE = 36;
policyParser.PAYING = 37;
policyParser.PER = 38;
policyParser.VIEW = 39;
policyParser.REQUIRE = 40;
policyParser.NOTHING = 41;
policyParser.ID = 42;
policyParser.WS = 43;
policyParser.INT = 44;
policyParser.DATE = 45;

policyParser.RULE_p = 0;
policyParser.RULE_duration_clause = 1;
policyParser.RULE_segment = 2;
policyParser.RULE_settlement_clause = 3;
policyParser.RULE_audience_clause = 4;
policyParser.RULE_audience_individuals_clause = 5;
policyParser.RULE_audience_groups_clause = 6;
policyParser.RULE_state_clause = 7;
policyParser.RULE_current_state_clause = 8;
policyParser.RULE_target_clause = 9;
policyParser.RULE_accepting = 10;
policyParser.RULE_event = 11;
policyParser.RULE_and_event = 12;
policyParser.RULE_settlement_time_event = 13;
...
policyParser.RULE_and = 31;
policyParser.RULE_view_unit = 32;
policyParser.RULE_time_unit = 33;
policyParser.RULE_start_hour = 34;
policyParser.RULE_end_hour = 35;
...
PContext.prototype.duration_clause = function() {
    return this.getTypedRuleContext(Duration_clauseContext,0);
};
...
PContext.prototype.settlement_clause = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
        return this.getTypedRuleContexts(Settlement_clauseContext);
    } else {
        return this.getTypedRuleContext(Settlement_clauseContext,i);
    }
};
...
function Duration_clauseContext(parser, parent, invokingState) {
	if(parent===undefined) {
	    parent = null;
	}
	if(invokingState===undefined || invokingState===null) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = policyParser.RULE_duration_clause;
    return this;
}

Duration_clauseContext.prototype = Object.create(antlr4.ParserRuleContext.prototype);
Duration_clauseContext.prototype.constructor = Duration_clauseContext;

Duration_clauseContext.prototype.DATE = function(i) {
	if(i===undefined) {
		i = null;
	}
    if(i===null) {
...
Duration_clauseContext.prototype.start_hour = function() {
    return this.getTypedRuleContext(Start_hourContext,0);
};

Duration_clauseContext.prototype.end_hour = function() {
    return this.getTypedRuleContext(End_hourContext,0);
};

Duration_clauseContext.prototype.enterRule = function(listener) {
    if(listener instanceof policyListener ) {
        listener.enterDuration_clause(this);
	}
};

Duration_clauseContext.prototype.exitRule = function(listener) {
    if(listener instanceof policyListener ) {
        listener.exitDuration_clause(this);
	}
};
...
policyParser.Duration_clauseContext = Duration_clauseContext;

policyParser.prototype.duration_clause = function() {

    var localctx = new Duration_clauseContext(this, this._ctx, this.state);
    this.enterRule(localctx, 2, policyParser.RULE_duration_clause);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 82;
...
policyParser.prototype.segment = function() {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while(_la===policyParser.T__8 || _la===policyParser.ID);
        this.state = 100;
...
function Settlement_clauseContext(parser, parent, invokingState) {
	if(parent===undefined) {
	    parent = null;
	}
	if(invokingState===undefined || invokingState===null) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = policyParser.RULE_settlement_clause;
    return this;
}

Settlement_clauseContext.prototype = Object.create(antlr4.ParserRuleContext.prototype);
Settlement_clauseContext.prototype.constructor = Settlement_clauseContext;

Settlement_clauseContext.prototype.INT = function() {
    return this.getToken(policyParser.INT, 0);
};

Settlement_clauseContext.prototype.ID = function(i) {
	if(i===undefined) {
		i = null;
	}
    if(i===null) {
...
Settlement_clauseContext.prototype.enterRule = function(listener) {
    if(listener instanceof policyListener ) {
        listener.enterSettlement_clause(this);
	}
};

Settlement_clauseContext.prototype.exitRule = function(listener) {
    if(listener instanceof policyListener ) {
        listener.exitSettlement_clause(this);
	}
};
...
policyParser.Settlement_clauseContext = Settlement_clauseContext;

policyParser.prototype.settlement_clause = function() {

    var localctx = new Settlement_clauseContext(this, this._ctx, this.state);
    this.enterRule(localctx, 6, policyParser.RULE_settlement_clause);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 107;
...
policyParser.prototype.audience_clause = function() {
    ...
    this.enterRule(localctx, 8, policyParser.RULE_audience_clause);
    var _la = 0; // Token type
    try {
        this.state = 125;
        this._errHandler.sync(this);
...
policyParser.prototype.audience_individuals_clause = function() {
    ...
    this.enterRule(localctx, 10, policyParser.RULE_audience_individuals_clause);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 127;
...
policyParser.prototype.audience_groups_clause = function() {
    ...
    this.enterRule(localctx, 12, policyParser.RULE_audience_groups_clause);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 135;
...
policyParser.prototype.state_clause = function() {
    ...
    this.enterRule(localctx, 14, policyParser.RULE_state_clause);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 144;
...
policyParser.prototype.current_state_clause = function() {
    ...
    this.enterRule(localctx, 16, policyParser.RULE_current_state_clause);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 150;
...
policyParser.prototype.target_clause = function() {
    ...
    this.enterRule(localctx, 18, policyParser.RULE_target_clause);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 154;
...
policyParser.prototype.accepting = function() {
    ...
    this.enterRule(localctx, 20, policyParser.RULE_accepting);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 171;
...
policyParser.prototype.event = function() {
    ...
    this.enterRule(localctx, 22, policyParser.RULE_event);
    try {
        this.state = 181;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
policyParser.prototype.and_event = function() {
    ...
    this.enterRule(localctx, 24, policyParser.RULE_and_event);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 183;
        this.match(policyParser.T__6);
...
policyParser.prototype.settlement_time_event = function() {
    ...
    this.enterRule(localctx, 26, policyParser.RULE_settlement_time_event);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 186;
...
policyParser.prototype.and = function() {
    ...
    this.enterRule(localctx, 62, policyParser.RULE_and);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 257;
        this.match(policyParser.T__6);
...
policyParser.prototype.view_unit = function() {
    ...
    this.enterRule(localctx, 64, policyParser.RULE_view_unit);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 259;
        _la = this._input.LA(1);
        if(!(_la===policyParser.T__22 || _la===policyParser.T__23)) {
...
policyParser.prototype.time_unit = function() {
    ...
    this.enterRule(localctx, 66, policyParser.RULE_time_unit);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 261;
        _la = this._input.LA(1);
        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << policyParser.T__10) | (1 << policyParser.T__24) | (1 << policyParser.T__25))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
...
policyParser.prototype.start_hour = function() {
    ...
    this.enterRule(localctx, 68, policyParser.RULE_start_hour);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 263;
        this.match(policyParser.INT);
...
policyParser.prototype.end_hour = function() {
    ...
    this.enterRule(localctx, 70, policyParser.RULE_end_hour);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 267;
        this.match(policyParser.INT);
