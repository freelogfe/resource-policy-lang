...
var literalNames = [ null, "'for'", "':'", "','", "'public'", "'nodes'", 
                     "'registered_users'", "'require'", "'contract'", "'with'", 
                     "'always'", "'['", "']'", "'citable'", "'procurable'", 
                     "'presentable'", "'=>'", "'terminate'", "'.'", "'('", 
                     "')'", "'='", "'+'", "'-'", "'*'", "'/'", "'^'", "'sum'", 
...
var symbolicNames = [ null, null, null, null, null, null, null, null, null, 
                      null, null, null, null, null, null, null, null, null, 
                      null, null, null, null, null, null, null, null, null, 
                      null, "ACCOUNT_NUMBER", "SUBJECT_SERVICE_NAME", "UOID", 
...
var ruleNames =  [ "policy", "audience_strict", "audience_clause", "users", 
                   ...
                   "declaration_statements", "service_state_constant", "state_definition_section", 
                   "state_definition", "state_name", "service_state_definition", 
                   "service_state", "state_transition", "subject_id", "entity_bracket", 
                   "account", "subject", "subject_service", "user_organization_name", 
                   "expression_test", "expression_assignment", "expression_handle", 
...
resourcePolicyParser.ACCOUNT_NUMBER = 28;
resourcePolicyParser.SUBJECT_SERVICE_NAME = 29;
resourcePolicyParser.UOID = 30;
resourcePolicyParser.SUBJECT_ID = 31;
resourcePolicyParser.ID = 32;
resourcePolicyParser.INT = 33;
resourcePolicyParser.USER_ID = 34;
resourcePolicyParser.PHONE_NUMBER_CN_MOBILE = 35;
resourcePolicyParser.EMAIL = 36;
resourcePolicyParser.PERIOD = 37;
resourcePolicyParser.TIME = 38;
resourcePolicyParser.DATE = 39;
resourcePolicyParser.MONEY_AMOUNT = 40;
resourcePolicyParser.WS = 41;
resourcePolicyParser.SCIENTIFIC_NUMBER = 42;
resourcePolicyParser.PI = 43;
resourcePolicyParser.EULER = 44;
resourcePolicyParser.VARIABLE_CONTRACT = 45;
resourcePolicyParser.EVENT_SERVICE_NAME = 46;
...
resourcePolicyParser.RULE_state_definition_section = 9;
resourcePolicyParser.RULE_state_definition = 10;
resourcePolicyParser.RULE_state_name = 11;
resourcePolicyParser.RULE_service_state_definition = 12;
resourcePolicyParser.RULE_service_state = 13;
resourcePolicyParser.RULE_state_transition = 14;
resourcePolicyParser.RULE_subject_id = 15;
resourcePolicyParser.RULE_entity_bracket = 16;
resourcePolicyParser.RULE_account = 17;
resourcePolicyParser.RULE_subject = 18;
resourcePolicyParser.RULE_subject_service = 19;
resourcePolicyParser.RULE_user_organization_name = 20;
resourcePolicyParser.RULE_expression_test = 21;
resourcePolicyParser.RULE_expression_assignment = 22;
resourcePolicyParser.RULE_expression_handle = 23;
resourcePolicyParser.RULE_expression = 24;
resourcePolicyParser.RULE_multiplyingExpression = 25;
resourcePolicyParser.RULE_powExpression = 26;
resourcePolicyParser.RULE_signedAtom = 27;
resourcePolicyParser.RULE_built_in_function = 28;
resourcePolicyParser.RULE_funcname = 29;
resourcePolicyParser.RULE_atom = 30;
resourcePolicyParser.RULE_scientific = 31;
resourcePolicyParser.RULE_constant = 32;
resourcePolicyParser.RULE_variable = 33;
resourcePolicyParser.RULE_expression_call_or_literal = 34;
resourcePolicyParser.RULE_expression_call = 35;
resourcePolicyParser.RULE_expression_call_argument = 36;
resourcePolicyParser.RULE_environment_variable = 37;
resourcePolicyParser.RULE_event = 38;
resourcePolicyParser.RULE_event_service = 39;
resourcePolicyParser.RULE_event_path = 40;
resourcePolicyParser.RULE_event_name = 41;
resourcePolicyParser.RULE_event_args = 42;
...
Audience_strictContext.prototype.requirement = function() {
...
resourcePolicyParser.prototype.users = function() {
    ...
    try {
        ...
        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << resourcePolicyParser.T__3) | (1 << resourcePolicyParser.T__4) | (1 << resourcePolicyParser.T__5))) !== 0))) {
...
resourcePolicyParser.prototype.service_state_constant = function() {
    ...
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 127;
        localctx.type = this.match(resourcePolicyParser.T__9);
        this.state = 128;
        this.service_state();
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
...
resourcePolicyParser.prototype.state_definition_section = function() {
    ...
    this.enterRule(localctx, 18, resourcePolicyParser.RULE_state_definition_section);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 131; 
...
resourcePolicyParser.prototype.state_definition = function() {
    ...
    this.enterRule(localctx, 20, resourcePolicyParser.RULE_state_definition);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 135;
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if(_la===resourcePolicyParser.T__10) {
            this.state = 136;
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while(_la===resourcePolicyParser.T__16 || _la===resourcePolicyParser.EVENT_SERVICE_NAME);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
resourcePolicyParser.prototype.state_name = function() {
    ...
    this.enterRule(localctx, 22, resourcePolicyParser.RULE_state_name);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 145;
...
resourcePolicyParser.prototype.service_state_definition = function() {
    ...
    this.enterRule(localctx, 24, resourcePolicyParser.RULE_service_state_definition);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 147;
...
resourcePolicyParser.prototype.service_state = function() {
    ...
    this.enterRule(localctx, 26, resourcePolicyParser.RULE_service_state);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 158;
        _la = this._input.LA(1);
        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << resourcePolicyParser.T__12) | (1 << resourcePolicyParser.T__13) | (1 << resourcePolicyParser.T__14))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
...
resourcePolicyParser.prototype.state_transition = function() {
    ...
    this.enterRule(localctx, 28, resourcePolicyParser.RULE_state_transition);
    try {
        this.state = 165;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
resourcePolicyParser.prototype.subject_id = function() {
    ...
    this.enterRule(localctx, 30, resourcePolicyParser.RULE_subject_id);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 167;
        this.subject();
...
resourcePolicyParser.prototype.entity_bracket = function() {
    ...
    this.enterRule(localctx, 32, resourcePolicyParser.RULE_entity_bracket);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 176;
...
resourcePolicyParser.prototype.account = function() {
    ...
    this.enterRule(localctx, 34, resourcePolicyParser.RULE_account);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 181;
...
resourcePolicyParser.prototype.subject = function() {
    ...
    this.enterRule(localctx, 36, resourcePolicyParser.RULE_subject);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 183;
        this.subject_service();
...
resourcePolicyParser.prototype.subject_service = function() {
    ...
    this.enterRule(localctx, 38, resourcePolicyParser.RULE_subject_service);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 189;
...
resourcePolicyParser.prototype.user_organization_name = function() {
    ...
    this.enterRule(localctx, 40, resourcePolicyParser.RULE_user_organization_name);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 191;
...
resourcePolicyParser.prototype.expression_test = function() {
    ...
    this.enterRule(localctx, 42, resourcePolicyParser.RULE_expression_test);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 194; 
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while(((((_la - 19)) & ~0x1f) == 0 && ((1 << (_la - 19)) & ((1 << (resourcePolicyParser.T__18 - 19)) | (1 << (resourcePolicyParser.T__21 - 19)) | (1 << (resourcePolicyParser.T__22 - 19)) | (1 << (resourcePolicyParser.T__26 - 19)) | (1 << (resourcePolicyParser.ID - 19)) | (1 << (resourcePolicyParser.INT - 19)) | (1 << (resourcePolicyParser.SCIENTIFIC_NUMBER - 19)) | (1 << (resourcePolicyParser.PI - 19)) | (1 << (resourcePolicyParser.EULER - 19)) | (1 << (resourcePolicyParser.VARIABLE_CONTRACT - 19)))) !== 0));
        this.state = 198;
        this.match(resourcePolicyParser.EOF);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
...
resourcePolicyParser.prototype.expression_assignment = function() {
    ...
    this.enterRule(localctx, 44, resourcePolicyParser.RULE_expression_assignment);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 200;
...
resourcePolicyParser.prototype.expression_handle = function() {
    ...
    this.enterRule(localctx, 46, resourcePolicyParser.RULE_expression_handle);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 216;
        this.match(resourcePolicyParser.ID);
...
resourcePolicyParser.prototype.expression = function() {
    ...
    this.enterRule(localctx, 48, resourcePolicyParser.RULE_expression);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 218;
        ...
        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
            if(_alt===1) {
                this.state = 219;
                _la = this._input.LA(1);
                if(!(_la===resourcePolicyParser.T__21 || _la===resourcePolicyParser.T__22)) {
                this._errHandler.recoverInline(this);
                }
                else {
                	this._errHandler.reportMatch(this);
...
resourcePolicyParser.prototype.multiplyingExpression = function() {
    ...
    this.enterRule(localctx, 50, resourcePolicyParser.RULE_multiplyingExpression);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 226;
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while(_la===resourcePolicyParser.T__23 || _la===resourcePolicyParser.T__24) {
            this.state = 227;
            _la = this._input.LA(1);
            if(!(_la===resourcePolicyParser.T__23 || _la===resourcePolicyParser.T__24)) {
            this._errHandler.recoverInline(this);
            }
            else {
            	this._errHandler.reportMatch(this);
...
resourcePolicyParser.prototype.powExpression = function() {
    ...
    this.enterRule(localctx, 52, resourcePolicyParser.RULE_powExpression);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 234;
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while(_la===resourcePolicyParser.T__25) {
            this.state = 235;
...
resourcePolicyParser.prototype.signedAtom = function() {
    ...
    this.enterRule(localctx, 54, resourcePolicyParser.RULE_signedAtom);
    try {
        this.state = 248;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
resourcePolicyParser.prototype.built_in_function = function() {
    ...
    this.enterRule(localctx, 56, resourcePolicyParser.RULE_built_in_function);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 250;
...
resourcePolicyParser.prototype.funcname = function() {
    ...
    this.enterRule(localctx, 58, resourcePolicyParser.RULE_funcname);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 262;
...
resourcePolicyParser.prototype.atom = function() {
    ...
    this.enterRule(localctx, 60, resourcePolicyParser.RULE_atom);
    try {
        this.state = 272;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
resourcePolicyParser.prototype.scientific = function() {
    ...
    this.enterRule(localctx, 62, resourcePolicyParser.RULE_scientific);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 274;
...
resourcePolicyParser.prototype.constant = function() {
    ...
    this.enterRule(localctx, 64, resourcePolicyParser.RULE_constant);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 276;
...
resourcePolicyParser.prototype.variable = function() {
    ...
    this.enterRule(localctx, 66, resourcePolicyParser.RULE_variable);
    try {
        this.state = 280;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
resourcePolicyParser.prototype.expression_call_or_literal = function() {
    ...
    this.enterRule(localctx, 68, resourcePolicyParser.RULE_expression_call_or_literal);
    try {
        this.state = 284;
        this._errHandler.sync(this);
...
resourcePolicyParser.prototype.expression_call = function() {
    ...
    this.enterRule(localctx, 70, resourcePolicyParser.RULE_expression_call);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 286;
...
resourcePolicyParser.prototype.expression_call_argument = function() {
    ...
    this.enterRule(localctx, 72, resourcePolicyParser.RULE_expression_call_argument);
    try {
        this.state = 305;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
resourcePolicyParser.prototype.environment_variable = function() {
    ...
    this.enterRule(localctx, 74, resourcePolicyParser.RULE_environment_variable);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 307;
...
resourcePolicyParser.prototype.event = function() {
    ...
    this.enterRule(localctx, 76, resourcePolicyParser.RULE_event);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 309;
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if(_la===resourcePolicyParser.T__18) {
            this.state = 317;
            this.event_args();
        }
...
resourcePolicyParser.prototype.event_service = function() {
    ...
    this.enterRule(localctx, 78, resourcePolicyParser.RULE_event_service);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 320;
...
resourcePolicyParser.prototype.event_path = function() {
    ...
    this.enterRule(localctx, 80, resourcePolicyParser.RULE_event_path);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 324; 
        this._errHandler.sync(this);
...
resourcePolicyParser.prototype.event_name = function() {
    ...
    this.enterRule(localctx, 82, resourcePolicyParser.RULE_event_name);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 330;
        this.match(resourcePolicyParser.ID);
...
resourcePolicyParser.prototype.event_args = function() {
    ...
    this.enterRule(localctx, 84, resourcePolicyParser.RULE_event_args);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 332;
